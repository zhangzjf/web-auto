...
public class Test003 {
	...
	public static void tec1 () throws Exception {
	    ...
	    chrome.findElementByCssSelector("#root > div > div > div > div > div > div > div > div:nth-child(1) > input").sendKeys("S00000000052");;
	    chrome.findElementByCssSelector("#root > div > div > div > div > div > div > div > div:nth-child(2) > input").sendKeys("Aa1234561122");
